...
function App() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (mode === "search") {
                ...
                data = await fetchMoviesByGenreOrYear(filter.genreId, filter.year, currentPage)
            } else {
  ...
  return (
      <div className="min-h-screen bg-gray-100 p-8">
          <SearchBar onSearch={handleSubmit} onSelectMovie={(movie) => setSelectedMovies(movie)} searchFunction={searchMovies} onClear={() => {
              setQuery("");
              setMode("trending");
              setCurrentPage(1);
          }}/>
